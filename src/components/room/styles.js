...
export const styles = StyleSheet.create({
  ...
  themeGridRow: { gap: 12, marginBottom: 12 },
  themeGridContent: { paddingVertical: 5, paddingBottom: 12 },
  themeCardItem: { width: '30%', aspectRatio: 1, borderRadius: 14, padding: 25, borderWidth: 1, alignItems: 'center', position: 'relative' },
